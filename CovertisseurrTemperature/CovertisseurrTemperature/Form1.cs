namespace CovertisseurrTemperature
{
    public partial class Form1 : Form
    {
        ...
        {
            txbTemperatureCelcius.Text = this.temperature_sortie_celcius.ToString();
        }

        private void txbTemperatureFahrenheit_TextChanged(object sender, EventArgs e)
        {
            txbTemperatureFahrenheit.Text = this.temperature_sortie_fahrenheit.ToString();
        }
        ...
        private void btnConvertir_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    temperature_sortie_celcius = calculer.CelciusVersFahrenheit();
                    temperature_sortie_fahrenheit = temperature_entree;
                }
                else if (cbbTypeEntree.Text == "Fahrenheit")
                {
                    temperature_sortie_fahrenheit = calculer.FahrenheitVersCelcius();
